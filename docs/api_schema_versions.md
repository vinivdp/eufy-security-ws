...
* Added new commands `snooze`, `unlock`, `is_downloading`, `start_talkback`, `stop_talkback`, `is_talkback_ongoing`, `talkback_audio_data`, `add_user`, `delete_user`, `get_users`, `update_user_passcode`, `update_user_schedule`, `update_user` and `verify_pin` to Device
